...
const createLocationHistory = () => {
    ...
    const updateByHistoryPosition = (routeInfo) => {
...
const createViewStacks = (router) => {
     ...
     * for both view items.
     */
    const findViewIndex = (viewStack, enteringViewItem, leavingViewItem) => {
        let enteringIndex = -1;
        let leavingIndex = -1;
     ...
     */
    const unmountLeavingViews = (outletId, enteringViewItem, leavingViewItem) => {
        const viewStack = viewStacks[outletId];
        if (!viewStack)
            return;
     ...
     */
    const mountIntermediaryViews = (outletId, enteringViewItem, leavingViewItem) => {
        const viewStack = viewStacks[outletId];
        if (!viewStack)
            return;
